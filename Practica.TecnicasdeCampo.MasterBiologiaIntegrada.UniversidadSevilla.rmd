...
color.plot.phylo(my.phylo.maker$scenario.2$run.1, mydata, names(mydata)[2], "Especie_PL", leg.cex = 0.6, main = paste0(names(mydata)[2]))
color.plot.phylo(my.phylo.maker$scenario.2$run.1, mydata, names(mydata)[13], "Especie_PL", leg.cex = 0.6, main = paste0(names(mydata)[13]))
